export type UserId = "brian" | "kevin" | "rick" | "lee" | "gene" | "legacyauto";
...
export const USER_LIST: User[] = [USERS.brian, USERS.kevin, USERS.rick, USERS.lee, USERS.gene, USERS.legacyauto];
