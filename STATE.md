...
2. `public/digests.json` — per-ticker AI-generated news digests, six time windows (1D/1W/1M/3M/1Y/ALL). Generated by `scripts/digest.swift` once per day at 7am.
...
[swift] scripts/digest.swift
   ...
   │
   └─ write public/digests.json  (~360 KB for all 29 tickers × 6 windows)
```
